    ...
    setCart({
      ...
      products: cart.products.map((product) => {
        if (product.id === newProduct.id)
          return {
            ...product,
            price: (product.price += newProduct.price),
            qty: (product.qty += newProduct.qty),
          };
        return product;
      }),
      totalPrice: cart.products[0].price + cart.products[1].price,
    });
  };
      ...
      products: cart.products.map((product) => {
        if (product.id === removedProduct.id)
          return {
            ...product,
            price:
              product.price === 0 ? 0 : (product.price -= removedProduct.price),
            qty: product.qty === 0 ? 0 : (product.qty -= removedProduct.qty),
          };
        return product;
      }),
      totalPrice: cart.products[0].price + cart.products[1].price,
