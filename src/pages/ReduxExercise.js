...
const ProductOne = (props) => {
  ...
  const dataFristProduct = useSelector((state) => state.product[0]);
  const product = { ...dataFristProduct };
...
const ProductTwo = (props) => {
  ...
  // You should see the price is updated
  const dataSecondProduct = useSelector((state) => state.product[1]);
  const product = { ...dataSecondProduct };
  // Step 9
...
const CartProductOne = (props) => {
  ...
  const dataProducts = useSelector((state) => state.cart.products[0]);
...
const CartProductTwo = (props) => {
  ...
  // Change the price of products in `service/cart/slice.js` to see the effect
  const dataProducts = useSelector((state) => state.cart.products[1]);
  const product = { ...dataProducts };
